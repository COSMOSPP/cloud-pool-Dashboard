...
export const infraData = [
  ...
  { name: 'xx连通率', value: 99, color: '#3b82f6' },
...
export const nodeStatusCards = [
  { name: 'xx亦庄节点', location: 'xx · 亦庄', pue: '1.32', status: '正常' },
  { name: 'xx临港节点', location: 'xx · 临港', pue: '1.38', status: '正常' },
  { name: 'xx南沙节点', location: 'xx · 南沙', pue: '1.28', status: '正常' },
  { name: 'xx贵安节点', location: 'xx · 贵安', pue: '1.22', status: '正常' },
  { name: 'xx和林格尔', location: '呼和浩特 · 和林', pue: '1.15', status: '正常' },
  { name: 'xx张北节点', location: '张家口 · 张北', pue: '1.18', status: '正常' },
];
...
export const topAlarmEvents = [
  ...
  { id: 5, name: 'xx链路丢包率高', level: '一般', levelClass: 'bg-blue-500/20 text-blue-400 border-blue-500/40', time: '05-20 10:22', status: '已处置', statusClass: 'text-emerald-400 font-bold' },
];
...
export const resourceAllocationData = [
  { name: 'CPU', percent: 44.85, total: '4,290 核', allocated: '1,924 核', color: '#0088ff' },
  { name: '内存', percent: 45.89, total: '11.65 TB', allocated: '5.34 TB', color: '#f59e0b' },
  { name: '块存储', percent: 46.10, total: '453.49 TB', allocated: '209.08 TB', cloudDisk: '160.50 TB', other: '48.58 TB', color: '#10b981' },
];
...
export const vmTop5Data = {
  cpu: [
    { rank: '01', name: 'xxxx计算机xxxx自监管分析处置平台04', value: 49 },
    { rank: '02', name: '虚拟机微隔离管理系统', value: 19 },
    { rank: '03', name: 'xxxxxx-xxxx办公平台-redis-测试', value: 18 },
    { rank: '04', name: 'xxxx平台01', value: 18 },
    { rank: '05', name: 'xx一体化履职服务平台01', value: 14 },
  ],
  memory: [
    { rank: '01', name: 'xx机要xx综合业务管理平台-xx数据库-备', value: 63 },
    { rank: '02', name: 'xxxx平台02', value: 60 },
    { rank: '03', name: 'xxxx平台01', value: 59 },
    { rank: '04', name: 'xxxx计算机xxxx自监管分析处置平台04', value: 51 },
    { rank: '05', name: 'xx天擎终端安全管理系统', value: 43 },
  ]
};
...
export const vmTop10Data = {
  cpu: [
    ...
    { rank: '03', name: 'xxxxxx-xxxx办公平台-redis-测试', value: 35 },
    { rank: '04', name: 'xxxx平台01', value: 31 },
    { rank: '05', name: 'xx一体化履职服务平台01', value: 28 },
    ...
    { rank: '10', name: '统一xx中心 SSO 节点02', value: 14 },
  ],
  memory: [
    { rank: '01', name: 'xx机要xx综合业务管理平台-xx数据库-备', value: 85 },
    { rank: '02', name: 'xxxx平台02', value: 78 },
    { rank: '03', name: 'xxxx平台01', value: 72 },
    { rank: '04', name: 'xxxx计算机xxxx自监管分析处置平台04', value: 68 },
    { rank: '05', name: 'xx天擎终端安全管理系统', value: 62 },
...
export const departmentAppsData = [
  ...
  { id: 4, name: 'xx安全防护防火墙', type: 'Linux / DPDK', vms: '2台', status: '正常', health: 100 },
...
export function getDepartmentAppsData(deptName: string): ApplicationResourceItem[] {
  ...
  if (deptName.includes('安全') || deptName.includes('Sec')) {
    return [
      { id: 1, name: 'xx流量入侵检测系统 IDS', vms: 8, cpu: '48 核', cpuPercent: 65, mem: '96 GB', memPercent: 70, disk: '1500 GB', diskPercent: 60 },
      ...
      { id: 5, name: '密钥与敏感数据xx保险箱', vms: 4, cpu: '16 核', cpuPercent: 25, mem: '32 GB', memPercent: 30, disk: '300 GB', diskPercent: 20 },
      { id: 6, name: '零信任xx访问控制 ZTNA', vms: 6, cpu: '24 核', cpuPercent: 44, mem: '48 GB', memPercent: 50, disk: '500 GB', diskPercent: 32 },
    ];
  }
  // 默认（研发中心及其下属团队）
  return [
    ...
    { id: 3, name: '统一xx中心 SSO', vms: 6, cpu: '24 核', cpuPercent: 35, mem: '48 GB', memPercent: 42, disk: '300 GB', diskPercent: 28 },
